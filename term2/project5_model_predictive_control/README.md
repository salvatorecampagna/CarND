...
In this project the vehicle behavior is modeled by means of a simplified, but good enough, **kinematic model**. The kinematic model ignores things like gravity, mass and tyre forces and is relatively simple to use.  
...
The Cross-Track Error and Heading Error equations are as follows:
